...
public class NotifiyUtil {
    ...
    private MailAccount fetchMailAcct() throws JwBlogException {
        ...
        String host = webconfBizService.queryWebconfByKey(WebConfDataConfig.EMAIL_HOST);
        String port = webconfBizService.queryWebconfByKey(WebConfDataConfig.EMAIL_PORT);
        String sender = webconfBizService.queryWebconfByKey(WebConfDataConfig.EMAIL_SENDER);
        String user = webconfBizService.queryWebconfByKey(WebConfDataConfig.EMAIL_USER);
        String pwd = webconfBizService.queryWebconfByKey(WebConfDataConfig.EMAIL_PWD);
        String ttlsEnable = webconfBizService.queryWebconfByKey(WebConfDataConfig.EMAIL_STARTTLS);
        String sslEnable = webconfBizService.queryWebconfByKey(WebConfDataConfig.EMAIL_SSL);
        String socketFactoryClass = webconfBizService.queryWebconfByKey(WebConfDataConfig.EMAIL_SOCKET_FACTORY_CLASS);
        String socketFactoryFallback = webconfBizService.queryWebconfByKey(WebConfDataConfig.EMAIL_SOCKET_FACTORY_FALLBACK);
        String socketFactoryPort = webconfBizService.queryWebconfByKey(WebConfDataConfig.EMAIL_SOCKET_FACTORY_PORT);
        String timeout = webconfBizService.queryWebconfByKey(WebConfDataConfig.EMAIL_STMT_TIMEOUT);
        String connectionTimeout = webconfBizService.queryWebconfByKey(WebConfDataConfig.EMAIL_CONNECTION_TIMEOUT);
